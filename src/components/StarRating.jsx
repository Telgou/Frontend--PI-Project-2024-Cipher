...
const StarRating = ({ averageRating, postId }) => {
  ...
  const handleStarClick = async (value) => {
    try {
      ...
      const response = await axios.post(process.env.REACT_APP_API ? process.env.REACT_APP_API : `https://backend-pi-project-2024-cipher-production.up.railway.app`+`/activity/addActivityFeedback/${postId}`, { rating: value });
